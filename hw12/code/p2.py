...
c = np.array([-1, -3, 0, 0]).astype(float)
A = np.array([[1, 1, 1, 0], [-1, 2, 0, 1]]).astype(float)
b = np.array([6, 8]).astype(float)

x0 = np.array([2, 1, 3, 8]).astype(float)
